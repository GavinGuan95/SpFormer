...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("downsample_with_hash_with_features_wrapper", &downsample_with_hash_with_features_wrapper, "downsample_with_hash_with_features_wrapper");
    m.def("downsample_with_hash_with_features_reuse_densemap_wrapper", &downsample_with_hash_with_features_reuse_densemap_wrapper, "downsample_with_hash_with_features_reuse_densemap_wrapper");
    m.def("downsample_with_hash_with_features_reuse_densemap_stridetag_wrapper", &downsample_with_hash_with_features_reuse_densemap_stridetag_wrapper, "downsample_with_hash_with_features_reuse_densemap_stridetag_wrapper");
    ...
    m.def("subm_strided_attention_with_hash_reuse_densemap_wrapper", &subm_strided_attention_with_hash_reuse_densemap_wrapper, "subm_strided_attention_with_hash_reuse_densemap_wrapper");
    m.def("subm_strided_attention_with_hash_reuse_densemap_stridetag_wrapper", &subm_strided_attention_with_hash_reuse_densemap_stridetag_wrapper, "subm_strided_attention_with_hash_reuse_densemap_stridetag_wrapper");
